...
case_dir = uigetdir('~/Documents/nexrad');
dir_name=[case_dir '/mat/']; %gets the name of the directory where *.mat files are located

base_dir='/Users/schneider/Documents/'; %This is your main directory where this script is run
...
pos1=[1+adjust_pos(1) adjust_pos(2) winsize]; pos2=[winsize(1)+1+adjust_pos(1) adjust_pos(2) winsize]; pos6=[1+adjust_pos(1) 1+winsize(1) 700 90]; pos8=[winsize(1)+adjust_pos(1) adjust_pos(2) 260 100]; pos7=pos8;
pos3=[1+adjust_pos(1) 1+winsize(1) winsize]; pos4=[1+adjust_pos(1)+winsize(1) 1+winsize(1) winsize]; pos5=[1+adjust_pos(1)+2*winsize(1) adjust_pos(2) winsize]; pos9=[1+adjust_pos(1)+2*winsize(1) 1+winsize(1) winsize]; pos10=pos6; pos10(3)=pos10(3)-300;
